...
def retrieveTree(i):
    listOfTrees = [{'no surfactin': {0: 'no', 1: {'flippers': {0: 'no', 1: 'yes'}}}},{'no surfactin': {0: {'head':{0:'no',1:'yes'}}, 1: {'flippers': {0: 'no', 1: 'yes'}}}}]
...
def createPlot(inTree):
    ...
    plotTree.xOff = -.05/plotTree.totalW;plotTree.yOff = 1.0;
